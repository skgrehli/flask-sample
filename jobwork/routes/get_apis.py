from flask import request, Blueprint, url_for, session, jsonify,render_template,redirect,make_response,Flask,send_from_directory
...
get_route = Blueprint('mold', __name__, url_prefix='', template_folder='templates')
...
@get_route.route('/jobrelated',methods=['get'])
def jobrelated():
